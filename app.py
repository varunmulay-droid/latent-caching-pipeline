...
def handle_upload(files):
    ...
    for file_obj in files:
        ...
        # Read from the temp file gradio provides
...
def build_ui():
    ...
    with gr.Blocks(theme=THEME, css=CSS, title="WAN 2.1 Latent Cacher") as app:
        ...
        with gr.Tab("☁️ Drive Sync", id="drive"):
            ...
            with gr.Row():
                mount_btn = gr.Button("🔗 Mount Google Drive", variant="primary", scale=1)
                mount_status = gr.Markdown("Click Mount to connect Google Drive.", scale=2)
